    ...
    if (empty($patiente_id) || empty($date_accouchement) || empty($mode_accouchement) || empty($medecin_id) || empty($sexe_bebe)) {
        ...
        try {
            ...
            ", [
                ...
                $complications, $observations, $id
            ]);
            
            $success = 'Accouchement modifié avec succès !';
            
            // Recharger les données de l'accouchement
            $accouchement = $db->fetch("
                SELECT a.*, p.nom, p.prenom
                FROM accouchements a
                JOIN patientes p ON a.patiente_id = p.id
        ...
        <div class="flex-1">
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600">Modifier les informations de l'accouchement #<?php echo $id; ?></p>
                </div>
                    ...
                    <form method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="patiente_id" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500">
                                    ...
                                    <?php foreach ($patientes as $patiente): ?>
                                        <option value="<?php echo $patiente['patiente_id']; ?>" <?php echo $accouchement['patiente_id'] == $patiente['patiente_id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="duree_travail" min="0" value="<?php echo htmlspecialchars($accouchement['duree_travail'] ?? ''); ?>"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500">
                            </div>
                        </div>
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="nom_bebe" value="<?php echo htmlspecialchars($accouchement['nom_bebe'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="apgar_score" min="0" max="10" value="<?php echo htmlspecialchars($accouchement['apgar_score'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                <div>
                                    ...
                                    <input type="number" step="0.001" name="poids_bebe" min="0" value="<?php echo htmlspecialchars($accouchement['poids_bebe'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="taille_bebe" min="0" value="<?php echo htmlspecialchars($accouchement['taille_bebe'] ?? ''); ?>"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea name="complications" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                                          placeholder="Décrivez les complications éventuelles..."><?php echo htmlspecialchars($accouchement['complications'] ?? ''); ?></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="observations" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
                                          placeholder="Observations générales..."><?php echo htmlspecialchars($accouchement['observations'] ?? ''); ?></textarea>
                            </div>
                        </div>
